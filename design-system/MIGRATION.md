...
| `border-neutral-300` (1)                                                                      | `border-line` (O6 fermée le 18/08/2026 : line-muted retiré, 1,48:1 non conforme 1.4.11)                                                                  | line = border-neutral-300 (via l'ex line-muted)                                     |
...
| `rounded-lg` (1, tooltip, 8px)                       | `rounded-ui` (O6 fermée le 18/08/2026 : tooltip corrigé dans le système, l'info_card Figma étant une annotation de maquette)                                              |
...
| 5   | Factorisation : NavLink, ActionInverse, BoutonSysteme (src/components/ui) ; tooltip corrigé dans ProjectHeader (O6, l'info_card Figma est une annotation de maquette) ; unification ease-in-out ; purge des classes inertes de Hero          | Mécanique après création des composants   | 12 chaînes + 4 fichiers          | Hovers de toute la nav, tooltip projet au clavier                                                                                      |
